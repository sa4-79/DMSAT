...
cat /home/sasghar/minisat/Debug/OutPuts/APP8 |grep -a --text 'SATI' | wc -l
echo 'Application Total timeout'
cat /home/sasghar/minisat/Debug/OutPuts/APP8 | grep  -a --text 'TimeOut' | wc -l
echo 'Application total submitted'
cat /home/sasghar/minisat/Debug/OutPuts/APP8 | grep -a --text '/home/sasgha' | wc -l
echo 'Application Total SATISFIABLE'
cat /home/sasghar/minisat/Debug/OutPuts/APP8 |grep  -a --text -v 'UNSATI' |grep -a --text 'SATI' | wc -l
echo 'Application Total UNSATISFIABLE'
cat /home/sasghar/minisat/Debug/OutPuts/APP8 |grep  -a --text 'UNSATI' | wc -l
echo '************************************************************'
